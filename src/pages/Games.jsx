...
<div id='About' className='bg-beige'>
    ...
    <div className="flex lg:flex-row flex-col gap-2  px-4 py-4 lg:py-8  lg:px-8">


{/* left */}
<div className='w-full  h-1/2 lg:w-1/2 '>
<div className='px-4 lg:bg-gradient-to-l  gap-4 bg-gradient-to-b flex flex-col      '>
...
{/* right */}
<div className='w-full lg:w-1/2  bg-wordgame   bg-cover bg-center bg-no-repeat h-[200px] lg:h-auto   px-1 lg:px-0 '>
...
{/* right */}
<div className='w-full lg:w-1/2  bg-patterngame    bg-center bg-no-repeat h-[200px] lg:h-auto   px-1 lg:px-0 '>
