...
import footerbg from '/Home/footerbg.png'
      ...
      <div className="relative flex justify-start md:justify-center md:items-end ">
        ...
        <div className="flex pt-36 md:pt-32 lg:pt-40 xl:pt-96   px-4 md:px-6  xl:px-20 flex-col justify-start items-start md:justify-center md:items-center relative z-10">
          <div className="flex  flex-col items-start justify-start xl:justify-center xl:space-x-8 xl:flex-row">
            <div className="flex justify-start items-center space-x-4">
              <div className="cursor-pointer flex justify-center items-center ">
               ...
               <h1 className='mt-3 text-orange-200 text-2xl font-atma font-bold'>TinyThinkers</h1>
            ...
            <div className="mt-12 xl:mt-0 grid grid-cols-1 sm:grid-cols-3 gap-y-12 sm:gap-y-0 w-full md:w-auto sm:gap-x-20 md:gap-x-28 xl:gap-8">
              ...
              <div className=" xl:w-72 flex justify-start items-start flex-col space-y-6">
                <h2 className="text-base xl:text-xl font-bold xl:font-semibold leading-4 xl:leading-5 text-white">Services</h2>
          ...
          <div className="mt-12 flex  xl:justify-between xl:flex-row flex-col-reverse items-center xl:items-start w-full ">
            <div className=''>
            <p className="mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-white">2024  Tiny Thinkers. All Rights Reserved</p>
            <div className='flex flex-col'>
<div className='flex justify-center items-end xl:items-center gap-x-2 mt-2'>
<span><FaPhone color='white' size={15} /></span>
<p className='mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-white'>+1 564 212 7158</p>

</div>
<div className='flex justify-center items-end xl:items-center gap-x-2  '>
<span><BiLogoGmail size={20}   color='white'/></span>
<p className='mt-10 md:mt-12 xl:mt-0 text-sm leading-none text-white'>admin@tinyThinkers.com</p>
            ...
            <div className="flex  justify-start md:justify-end items-start  w-full md:w-auto md:items-center space-x-6 ">
              ...
              <a  className="text-white hover:text-gray-200 w-6">
